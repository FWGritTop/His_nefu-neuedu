  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="申请id" prop="checkappid">
        <el-input v-model="queryParams.checkappid" placeholder="请输入检查申请id" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="项目id" prop="checkprojid">
        <el-input v-model="queryParams.checkprojid" placeholder="请输入检查项目id" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="科室id" prop="deptid">
        <el-input v-model="queryParams.deptid" placeholder="请输入执行科室id" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      ...
      <el-form-item label="状态" prop="state">
        <el-tooltip class="item" effect="dark" content="1 - 已开立未交费
          ...
          <el-input v-model="queryParams.state" placeholder="状态" clearable @keyup.enter.native="handleQuery" />
        </el-tooltip>
        <!-- 请输入1 - 已开立未交费
                              2 - 已交费未检查
                              3 - 已检查无结果
      ...
      <el-form-item label="选择项目" prop="identification">
        ...
        <el-tooltip class="item" effect="dark" content="请输入1 - 检查项
          ...
          <el-input v-model="queryParams.identification" placeholder="请输入对应项目号" clearable
      ...
      <el-form-item label="结果时间" prop="resulttime">
        <el-date-picker clearable v-model="queryParams.resulttime" type="date" value-format="yyyy-MM-dd"
          placeholder="请选择结果时间">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="录入人id" prop="userid2">
        <el-input v-model="queryParams.userid2" placeholder="请输入结果录入人员id" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="检查人id" prop="userid">
        <el-input v-model="queryParams.userid" placeholder="请输入检查人员id" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
          v-hasPermi="['system:checkdetailed:add']">新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="success" plain icon="el-icon-edit" size="mini" :disabled="single" @click="handleUpdate"
          v-hasPermi="['system:checkdetailed:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
          v-hasPermi="['system:checkdetailed:remove']">删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
          v-hasPermi="['system:checkdetailed:export']">导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="checkdetailedList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="开立时间" align="center" prop="creationtime" width="180">
      ...
      <el-table-column label="1 - 检查项
            2 - 检验项
            3 - 处置项" align="center" prop="identification" >
              <template slot-scope="scope">
      ...
      <el-table-column label="检查时间" align="center" prop="inspecttime" width="180">
        <template slot-scope="scope">
      ...
      <el-table-column label="检查结果" align="center" prop="result" >
        <template slot-scope="scope">
          <span v-show="scope.row.result!==null">
              <el-button type="text" icon="el-icon-document" @click="handleView(scope.row)" >查看结果</el-button>
          </span>
          <span v-show="scope.row.result===null">
              <el-button type="text" icon="el-icon-edit" @click="handleUpdate(scope.row)">录入结果</el-button>
          </span>
        </template>
      </el-table-column>
      <el-table-column label="结果时间" align="center" prop="resulttime" width="180">
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="目的要求" prop="position">
          <el-input v-model="form.position" type="textarea" placeholder="请输入检查目的和要求" />
        </el-form-item>
        <!-- 1 - 已开立未交费
            2 - 已交费未检查
            3 - 已检查无结果
        ...
        <el-form-item label="选择项目" prop="identification">
            <el-tooltip class="item" effect="dark" content="请输入1 - 检查项
                              2 - 检验项
                              3 - 处置项 " placement="top-start">
          <el-input v-model="form.identification" placeholder="请输入1 - 检查项
            2 - 检验项
            3 - 处置项" />
        </el-tooltip>
        </el-form-item>
        ...
        <el-form-item label="结果时间" prop="resulttime">
          <el-date-picker clearable v-model="form.resulttime" type="date" value-format="yyyy-MM-dd" placeholder="请选择结果时间">
          </el-date-picker>
        </el-form-item>
        <el-form-item label="录入人id" prop="userid2">
        ...
        <el-form-item label="删除标记" prop="delmark">
          <el-input v-model="form.delmark" placeholder="请输入删除标记delmark" />
        </el-form-item>
        <el-form-item label="删除标记" prop="isDelete">
          <el-input v-model="form.isDelete" placeholder="请输入删除标记isDelete" />
        </el-form-item>
...
<script>
import { listCheckdetailed, getCheckdetailed, delCheckdetailed, addCheckdetailed, updateCheckdetailed } from "@/api/system/checkdetailed";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除检查申请明细编号为"' + ids + '"的数据项？').then(function () {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/checkdetailed/export', {
        ...this.queryParams
